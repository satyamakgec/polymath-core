...
contract ModuleRegistry is IModuleRegistry, Ownable {
    ...
    */
    function useModule(address _moduleFactory) external {
        ...
        require(verified[_moduleFactory]||(IModuleFactory(_moduleFactory).owner() == ISecurityToken(msg.sender).owner()), "Module factory is not verified as well as not called by the owner");
