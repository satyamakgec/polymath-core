...
contract('PreSaleSTO', accounts => {
    ...
    // PreSale STO details
    let endTime;// = latestTime() + duration.days(20);           // Start time will be 5000 seconds more than the latest time
    // console.log("Initial latestTime: " + latestTime() + ":" + endTime);
    ...
    describe("Buy tokens", async() => {
        ...
        it("Should Buy the tokens", async() => {
            ...
            console.log("Buy latestTime: " + latestTime() + ":" + endTime);
